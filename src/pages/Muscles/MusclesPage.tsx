...
const katawanImage = [
  require("../../img/katawan_1.svg"),
  require("../../img/katawan_2.svg"),
  require("../../img/katawan_3.svg"),
]

class Muscles extends React.Component<any, any> {
      ...
      <div className="katawanContainer">
        ...
        <div className="katArticleContainer">
          <div className="katArticle">
            ...
            <img src={katawanImage[0]} className="katArticleImage" />
          </div>
        </div>
        ...
        <div className="separatorContentContainer">
          <img src={katawanImage[1]} className="separatorImageMain" />
        ...
        <div className="puntaNa">
          ...
          <Link to="/aruga-katawan/injuries">
